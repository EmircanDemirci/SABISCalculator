...
**SABISCalculator**, Sakarya Üniversitesi (SAÜ) öğrencilerinin kullandığı SABİS (OBS) sistemi üzerinde çalışan, açık kaynaklı bir Chrome eklentisidir. Hesaplamalar tahminidir, resmi sonuç yerine geçmez.
